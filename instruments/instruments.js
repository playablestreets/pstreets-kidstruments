let instruments = [
...

	{
		...
		description:
			'The bing bonga is made out of iron and wood. It makes lots of sounds like ding and rrrrrrr and also a wacking sound like wack wack wack kind of thingy.🦾🐰🦄🦉🐔🦊🐒🦥🌎🌈🌪',
		age: '5',
		postcode: '3066'
	},
...

	{
		id: 'kids_024',
		name: 'Erin',
		title: 'FLYING BIRD’S NEST',
		description:
			'It has different parts that sound like different stringed instruments – it has a Ukulele, Viola, Double Bass, Guitar (specifically a Les Paul), and two Harps (these are the wings of the bird).  In addition, the birds make tweeting sounds, the bouncy ball makes the sound of a ball bouncing on the footpath, and the strawberry and blueberry ice cream makes the sound of a person eating ice cream!  It is also sparkly.',
		age: '6',
		postcode: '3206'
	},
